...
OutputBaseFilename=BinaryFetch-Setup
...
[Files]
Source: "H:\programming\production\BinaryFetch\BinaryFetch.exe"; DestDir: "{app}"; Flags: ignoreversion
...
begin
  ...
  begin
    ...
    MsgBox(
      'BinaryFetch v1.0 installed successfully.'#13#13 +

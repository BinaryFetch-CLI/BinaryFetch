...
LicenseFile=H:\programming\git\_and\_github\BinaryFetch\build files\BinaryFetch v1.3\License.txt
SetupIconFile=H:\programming\git\_and\_github\BinaryFetch\build files\BinaryFetch v1.3\BinaryFetch.ico

OutputDir=H:\programming\git\_and\_github\BinaryFetch\build files\bin
...
[Files]
Source: "H:\programming\git\_and\_github\BinaryFetch\project\_binary\_fetch\binary\_fetch\_v1\x64\Release\BinaryFetch.exe"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{autoprograms}\BinaryFetch"; Filename: "{app}\{#MyAppExeName}"
Name: "{autodesktop}\BinaryFetch"; Filename: "{app}\{#MyAppExeName}"
...
begin
  ...
  begin
    ...
    begin
      ...
      if (Length(NewPaths) > 0) and
         (NewPaths[Length(NewPaths)] <> ';') then
        NewPaths := NewPaths + ';';

...
SetupIconFile=H:\programming\git_and_github\BinaryFetch\build files\BinaryFetch v1.3\BinaryFetch V1.3.ico
...
[Files]
Source: "H:\programming\git_and_github\BinaryFetch\project\binary_fetch\binary_fetch_v1\x64\Release\BinaryFetch.exe"; DestDir: "{app}"; Flags: ignoreversion
